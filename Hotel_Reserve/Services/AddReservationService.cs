...
namespace Hotel_Reserve.Services
{
    ...
    {
        private string getAllURL = "http://localhost:8080/RESTSample/rest/Reservation/Create";
        ...
        public Reservation reservation(Reservation reservation)
        {
            ...
            HttpResponseMessage response = client.PostAsJsonAsync(getAllURL, reservation).Result;  // Blocking call!
